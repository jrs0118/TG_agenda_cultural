<x-layouts.app :title="__('Editar Gestor Cultural')">

    <div class="container mx-auto px-4 py-8">
        <div class="max-w-2xl mx-auto">
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-2xl font-bold text-gray-900">Editar Gestor Cultural</h1>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <form method="POST" action="{{ route('seguridad.update', $usuario->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-4">
                        ...
                        <input type="password" name="password" 
                               class="w-full border rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-[#0033A0]">
                    ...
                    <div class="flex justify-end pt-4 border-t">
                        <button type="submit" class="bg-[#0033A0] text-white px-6 py-2 rounded-lg hover:bg-[#002070] transition">
                            <i class="fas fa-save mr-2"></i>Actualizar Gestor
                        </button>
                    </div>
                </form>
            </div>
